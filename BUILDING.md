...
いろいろと便利なことがあります．たぶん，実行ファイルやライブラリファイルを
デフォルトで見つけてくれると思います．
...
どちらかというと alias で，
```shell
alias /usr/local/bin/cmake cmake
```
としたほうがよいかもしれません．
別の解決策を後で示します．
