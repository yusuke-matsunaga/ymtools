...
//////////////////////////////////////////////////////////////////////
/// @class HashMapCell HashMap.h "ym/HashFunc.h"
/// @brief HashMap 用のセル
//////////////////////////////////////////////////////////////////////
template<typename Key_Type,
	 typename Value_Type>
...
//////////////////////////////////////////////////////////////////////
/// @class HashMap HashMap.h "ym/HashMap.h"
...
//////////////////////////////////////////////////////////////////////
/// @class HashMapIterator HashMap.h "ym/HashMap.h"
/// @brief HashMap の反復子
//////////////////////////////////////////////////////////////////////
template<typename Key_Type,
	 typename Value_Type>
...
{
  Cell* cell = reinterpret_cast<Cell*>(HashBase<Key_Type>::find_cell(key));
  assert_cond( cell != nullptr, __FILE__, __LINE__ );
  return cell->mValue;
}
